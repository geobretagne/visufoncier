...
excel_file_path = os.path.join(downloads_path, "base-pop-historiques-1876-2023.xlsx")
...
try:
    df_filtered.to_sql('insee_popmun_2022', engine, schema='visufoncier', if_exists='replace', index=False)
