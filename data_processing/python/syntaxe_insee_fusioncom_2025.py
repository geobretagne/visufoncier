...
url = "https://www.insee.fr/fr/statistiques/fichier/7671867/table_passage_geo2003_geo2025.zip"
...
zip_file_path = os.path.join(downloads_path, "table_passage_geo2003_geo2025.zip")

# Télécharger le fichier ZIP
urllib.request.urlretrieve(url, zip_file_path)

# Chemin complet du dossier extrait
extracted_folder_path = os.path.join(downloads_path, "table_passage_geo2003_geo2025")
...
excel_file_path = os.path.join(extracted_folder_path, "table_passage_geo2003_geo2025.xlsx")
...
filtered_csv_file_path = os.path.join(downloads_path, "insee_fusioncom_2025.csv")
...
try:
    df_filtered.to_sql('insee_fusioncom_2025', engine, schema='visufoncier', if_exists='replace', index=False)
