...
url_2020 = "https://www.insee.fr/fr/statistiques/fichier/7632867/base-cc-emploi-pop-active-2020_xlsx.zip"

# Chemin complet vers le dossier Téléchargements
downloads_path = os.path.expanduser("~/Downloads")

# Chemin complet du fichier ZIP à télécharger
zip_file_path_2020 = os.path.join(downloads_path, "base-cc-emploi-pop-active-2020_xlsx.zip")
...
excel_file_path_2020 = os.path.join(downloads_path, "base-cc-emploi-pop-active-2020_v2.xlsx")
...
df_filtered_2020 = df_filtered_2020[['codgeo', 'reg', 'dep', 'libgeo', 'p20_emplt']]

# Enregistrer les données filtrées dans un nouveau fichier CSV
filtered_csv_file_path_2020 = os.path.join(downloads_path, "donnees_emploi_2020.csv")
...
try:
    df_filtered.to_sql('insee_emploi_2020', engine, schema='visufoncier', if_exists='replace', index=False)
