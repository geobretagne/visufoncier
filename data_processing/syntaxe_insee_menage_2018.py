...
url_2018 = "https://www.insee.fr/fr/statistiques/fichier/5395819/base-ccx-coupl-fam-men-2018.zip"

# Chemin complet vers le dossier Téléchargements
downloads_path = os.path.expanduser("~/Downloads")

# Chemin complet du fichier ZIP à télécharger
zip_file_path_2018 = os.path.join(downloads_path, "base-cc-coupl-fam-men-2018_xlsx.zip")
...
excel_file_path_2018 = os.path.join(downloads_path, "base-cc-coupl-fam-men-2018.xlsx")
...
# Renommer la variable 'C18_MEN' si adaptation sur une autre année
df_filtered_2018 = df_filtered_2018[['codgeo', 'reg', 'dep', 'libgeo', 'c18_men']]

# Enregistrer les données filtrées dans un nouveau fichier CSV
filtered_csv_file_path_2018 = os.path.join(downloads_path, "donnees_menages_2018.csv")
...
try:
    df_filtered.to_sql('insee_menage_2018', engine, schema='visufoncier', if_exists='replace', index=False)
