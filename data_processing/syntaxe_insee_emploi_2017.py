...
url_2017 = "https://www.insee.fr/fr/statistiques/fichier/4515500/base-ccx-emploi-pop-active-2017.zip"

# Chemin complet vers le dossier Téléchargements
downloads_path = os.path.expanduser("~/Downloads")

# Chemin complet du fichier ZIP à télécharger
zip_file_path_2017 = os.path.join(downloads_path, "base-cc-emploi-pop-active-2017_xlsx.zip")
...
excel_file_path_2017 = os.path.join(downloads_path, "base-cc-emploi-pop-active-2017.xlsx")
...
print(df_filtered_2017)

# Conserver uniquement les colonnes spécifiées
df_filtered_2017 = df_filtered_2017[['codgeo', 'reg', 'dep', 'libgeo', 'p17_emplt']]

# Enregistrer les données filtrées dans un nouveau fichier CSV
filtered_csv_file_path_2017 = os.path.join(downloads_path, "donnees_emploi_2017.csv")
...
try:
    df_filtered.to_sql('insee_emploi_2017', engine, schema='visufoncier', if_exists='replace', index=False)
